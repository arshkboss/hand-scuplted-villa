...
import { MapPin, Clock, Phone,  Train, Plane, Bus, Coffee, Mountain, Trees, Camera } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="space-y-8 flex flex-col justify-evenly" 
          >
            {/* Address and Contact */}
            <div className="bg-card p-6 rounded-lg shadow-sm">
        ...
        <Button className="flex justify-center m-0 mx-auto mt-10" size="lg">
              Get Directions
            </Button>
      </div>
    </section>
