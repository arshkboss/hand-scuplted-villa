    ...
    <section className="py-20 overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto px-4 md:px-6 overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-background to-transparent pointer-events-none pr-10" />
          <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-background to-transparent pointer-events-none pl-10" />
        </div>
      </div>
    </section>
  )
