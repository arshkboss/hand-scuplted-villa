...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    location: "Australia",
    comment: "Worth every penny! The villa offers complete privacy while being close to amazing attractions. Well definitely return."
  },
]

// Create two separate arrays for different directions
const infiniteReviews = [...reviews, ...reviews, ...reviews]
const reverseInfiniteReviews = [...infiniteReviews].reverse()
...
export default function Reviews() {
  ...
  return (
    <section className="py-20 overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto px-4 md:px-0 overflow-hidden">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            className="flex"
          >
            {reverseInfiniteReviews.map((review, index) => (
